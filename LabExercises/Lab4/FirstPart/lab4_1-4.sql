...
FROM students JOIN student_sport ON
...
#3
SELECT coaches.name AS coach, sports.name AS sport, students.name AS student
...
#4
SELECT students.name AS studentName, students.class, sportgroups.location, coaches.name AS coachName
